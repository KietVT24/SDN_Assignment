...
export default function ProductsClient() {
  ...
  // Gọi API khi filters/page thay đổi
  useEffect(() => {
    loadProducts();
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-6 space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            {hasActiveFilters && (
              <Button variant="ghost" size="sm" onClick={() => (typeof window !== "undefined" ? window.location.reload() : null)}>
                Clear Filters
              </Button>
            )}
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-lg shadow-sm">
            ...
            {hasActiveFilters && <Button onClick={() => (typeof window !== "undefined" ? window.location.reload() : null)}>Clear Filters</Button>}
          </div>
        ) : (
          <div
            className={
