...
//       <Link href={`/products/${product._id}`}>Chi tiết</Link>
//       {session && (
//         <>
//           <Link href={`/products/edit/${product._id}`} style={{ marginLeft: 8 }}>Edit</Link>
//           <button style={{ marginLeft: 8 }} onClick={() => {/* gọi API xóa */}}>Delete</button>
//         </>
//       )}
//     </div>
//   );
